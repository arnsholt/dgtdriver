...
final class MoveList implements Iterable<Move> {
    ...
    private class Iterator implements java.util.Iterator<Move> {
        private int pos = 0;

        public boolean hasNext() { return pos < MoveList.this.size; }
        public Move next() { return MoveList.this.buffer[pos++]; }
    }
